...
SECRET_KEY = 'django-insecure-n$_onvm!vpqi#%4nuf8p)6+0!!y!5_t$uysfgqqyf)jye*+eq_'
...
# define Custom  Model class name("User")
...
EMAIL_HOST_USER='nihantalukdar55@gmail.com'
EMAIL_HOST_PASSWORD='swtmzknpcaawrxvb'
EMAIL_PORT=587